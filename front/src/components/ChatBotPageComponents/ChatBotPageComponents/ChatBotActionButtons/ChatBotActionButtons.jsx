...
const ChatBotActionButtons = () => {
  ...
  const handleError = (err) => {
    if (err.response) {
      setError(
        `Error: ${err.response.status} ${err.response.statusText} - ${err.response.data}`
      );
    } else if (err.request) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const res = await axios.post(
        import.meta.env.VITE_SERVER_URL + "bot/create_bot",
        {
  ...
  const startBot = async () => {
    ...
    try {
      const res = await axios.post(
        import.meta.env.VITE_SERVER_URL + "bot/start_bot",
        {
          bot_id: botId,
        }
      );
  ...
  const stopBot = async () => {
    ...
    try {
      const res = await axios.post(
        import.meta.env.VITE_SERVER_URL + "bot/stop_bot",
        {
          bot_id: botId,
          ticker: formData.cryptocurrency,
        }
  ...
  const pauseBot = async () => {
    ...
    try {
      const res = await axios.post(
        import.meta.env.VITE_SERVER_URL + "bot/pause_bot",
        {
          bot_id: botId,
          ticker: formData.cryptocurrency,
        }
  ...
  const resumeBot = async () => {
    ...
    try {
      const res = await axios.post(
        import.meta.env.VITE_SERVER_URL + "bot/resume_bot",
        {
          bot_id: botId,
          ticker: formData.cryptocurrency,
        }
  ...
  const deleteBot = async () => {
    ...
    try {
      const res = await axios.post(
        import.meta.env.VITE_SERVER_URL + "bot/delete_bot",
        {
          bot_id: botId,
        }
      );
  ...
  return (
    <div>
      ...
      <div className={classes.container}>
        <button className={classes.buttons} onClick={startBot}>
          start
        </button>
        <button className={classes.buttons} onClick={stopBot}>
          stop
        </button>
        <button className={classes.buttons} onClick={pauseBot}>
          pause
        </button>
        <button className={classes.buttons} onClick={resumeBot}>
          resume
        </button>
        <button className={classes.buttons} onClick={deleteBot}>
          delete
        </button>
      </div>
      {response && (
